    ...
    var e = (function () {
        ...
        (window.GetSelectWndInfo = function (e) {
          if (Z()) {
            (P = e),
              ...
              t.push("</RealPlayInfo>"),
              p.cbSelWnd && p.cbSelWnd(v.loadXML(t.join("")));
          } else {
            var t,
              n = v.loadXML(e);
            if (0 < re.$XML(n).find("SelectWnd", !0).length)
              (P = parseInt(re.$XML(n).find("SelectWnd").eq(0).text(), 10)),
                null === g && R(),
                (t = []).push("<RealPlayInfo>"),
                t.push("<SelectWnd>" + P + "</SelectWnd>"),
                t.push("</RealPlayInfo>"),
                p.cbSelWnd && p.cbSelWnd(v.loadXML(t.join("")));
            else if (0 < re.$XML(n).find("DoubleClickWnd", !0).length) {
              var r = parseInt(
                re.$XML(n).find("DoubleClickWnd").eq(0).text(),
                10
              );
              (s = "0" === re.$XML(n).find("IsFullScreen").eq(0).text()),
                p.cbDoubleClickWnd && p.cbDoubleClickWnd(r, s);
            }
          }
        }),
          ...
          (window.PluginEventHandler = function (e, t, n) {
            Z()
              ? p.cbEvent && p.cbEvent(e, t, n)
              : (0 == t || 2 == t
                  ? o.I_Stop(e)
                  : 21 == t
                  ? o.I_StopRecord(e)
                  : 3 == t && o.I_StopVoiceTalk(),
                p.cbEvent && p.cbEvent(t, e, n));
          }),
          ...
          (window.KeyBoardEventInfo = function (e) {
            100 === parseInt(e, 10) &&
              ((s = !1), p.cbDoubleClickWnd && p.cbDoubleClickWnd(P, s));
          });
        var b = function () {
            if (p.bDebugMode) {
              var e = T(arguments);
          ...
          L = function (e, t) {
            ...
            return (
              o.I_SendHTTPRequest(t, "ISAPI/Security/token?format=json", r), n
            );
          },
          l = function (e, t, n) {
            o.I_GetSecurityVersion(e, {
              success: function (e) {
                (oSecurityCap.iKeyIterateNum = parseInt(
                  re.$XML(e).find("keyIterateNum").eq(0).text(),
                  10
                )),
                  (oSecurityCap.oIrreversibleEncrypt = {
                    bSupport:
                      "true" === re.$XML(e).find("isIrreversible").eq(0).text(),
          ...
          q = function () {
            ...
            if (v.browser().msie)
              ...
              for (var t = navigator.mimeTypes.length, n = 0; n < t; n++)
                navigator.mimeTypes[n].type.toLowerCase() == p.szMimeTypes &&
                  (e =
            ...
            o.I_GetDeviceInfo(s.szIP, {
              ...
              o.I_GetAudioInfo(s.szIP, {
                success: function (e) {
                  ...
                  "" !== re.$XML(e).find("audioBitRate").eq(0).text()
                    ? (s.m_iAudioBitRate =
                        1e3 *
                        parseInt(
                          re.$XML(e).find("audioBitRate").eq(0).text(),
                    ...
                    : (s.m_iAudioBitRate = 0),
                    "" !== re.$XML(e).find("audioSamplingRate").eq(0).text()
                      ? (s.m_iAudioSamplingRate =
                          1e3 *
                          parseInt(
                            re.$XML(e).find("audioSamplingRate").eq(0).text(),
                            10
                          ))
                      : (s.m_iAudioSamplingRate = 0);
                },
              });
          },
          G = function (n) {
            (n.bSupportWebsocket = !1),
              (n.bSupportSubStreamPlayback = !1),
              n.oProtocolInc.getSystemCapa(n, {
                success: function (e) {
                  var t = re
                    .$XML(e)
                    .find("NetworkCap")
                  ...
                  0 < t.length &&
                    (n.bSupportWebsocket =
                      ...
                      re
                        ...
                        .eq(0)
                        .text()),
                    (n.bSupportWebsocket = !0),
                    0 <
                      (t = re
                        .$XML(e)
                        .find("RacmCap")
                        .eq(0)
                        .find("isSupportMainAndSubRecord", !0)).length &&
                      (n.bSupportSubStreamPlayback =
                        "true" ===
                        re
                          .$XML(e)
                          .find("RacmCap")
                  ...
                  for (var n = 0, r = t.length; n < r; n++)
                    "rtsp" ===
                      re
                        ...
                        .toLowerCase() &&
                      (s = parseInt(
                        re.$XML(t).eq(n).find("portNo").eq(0).text(),
                        10
                      )),
                      "http" ===
                        re
          ...
          _ = function (e) {
            ...
            return (
              e.oProtocolInc.getUPnPPortStatus(e, {
                ...
                success: function (e) {
                  for (
                    var t = re.$XML(e).find("portStatus", !0),
                      n = 0,
                      r = t.length;
                    n < r;
                    n++
                    ...
                    "rtsp" ==
                      re
                        ...
                        .toLowerCase() &&
                      (s = parseInt(
                        re.$XML(t).eq(n).find("externalPort").eq(0).text(),
                        10
                      )),
                      "http" ==
                        re
          ...
          H = function (t) {
            ...
            return (
              t.oProtocolInc.getNetworkBond(t, {
                async: !1,
                success: function (e) {
                  "true" == re.$XML(e).find("enabled").eq(0).text()
                    ? r.push({
                        ...
                        success: function (e) {
                          for (
                            var t = 0,
                              n = re
                                .$XML(e)
                                .find("NetworkInterface", !0).length;
                            t < n;
                            t++
                          ) {
                            r.push({
                ...
                error: function () {
                  t.oProtocolInc.getNetworkInterface(t, {
                    ...
                    success: function (e) {
                      for (
                        var t = 0,
                          n = re.$XML(e).find("NetworkInterface", !0).length;
                        t < n;
                        t++
                      ) {
                        r.push({
          ...
          k = function (e) {
            ...
            return (
              e.oProtocolInc.getPPPoEStatus(e, {
                ...
                success: function (e) {
                  t =
                    0 < re.$XML(e).find("ipAddress", !0).length ||
                    0 < re.$XML(e).find("ipv6Address", !0).length;
                },
                error: function () {
                  t = !1;
                },
          ...
          E = function (t) {
            t.oProtocolInc instanceof e &&
              t.oProtocolInc.getSDKCapa(t, {
                async: !1,
                success: function (e) {
                  (t.oStreamCapa.bObtained = !0),
                    (t.oStreamCapa.bSupportShttpPlay =
                      "true" ===
                      re.$XML(e).find("isSupportHttpPlay").eq(0).text()),
                    (t.oStreamCapa.bSupportShttpPlayback =
                      "true" ===
                      re.$XML(e).find("isSupportHttpPlayback").eq(0).text()),
                    (t.oStreamCapa.bSupportShttpsPlay =
                      "true" ===
                      re.$XML(e).find("isSupportHttpsPlay").eq(0).text()),
                    (t.oStreamCapa.bSupportShttpsPlayback =
                      "true" ===
                      re.$XML(e).find("isSupportHttpsPlayback").eq(0).text()),
                    (t.oStreamCapa.bSupportShttpPlaybackTransCode =
                      "true" ===
                      re
                        .$XML(e)
                        ...
                        .eq(0)
                        .text()),
                    (t.oStreamCapa.bSupportShttpsPlaybackTransCode =
                      "true" ===
                      re
                        .$XML(e)
                        ...
                        .eq(0)
                        .text()),
                    0 < re.$XML(e).find("ipChanBase", !0).length
                      ? (t.oStreamCapa.iIpChanBase = parseInt(
                          re.$XML(e).find("ipChanBase").eq(0).text(),
                          10
                        ))
                      : (t.oStreamCapa.iIpChanBase = 1);
                },
                error: function () {
                  t.oStreamCapa.bObtained = !0;
                },
          ...
          Z = function () {
            if (p.bNoPlugin) {
              var e = v.browser();
              return !!(
                (e.chrome && 45 < parseInt(e.version, 10)) ||
                (e.mozilla && 52 < parseInt(e.version, 10))
              );
            }
            return !1;
          },
          B = function (e) {
            ...
            return (
              p.proxyAddress &&
                ((t = p.proxyAddress.ip), (n = p.proxyAddress.port)),
              /^(http|https):\/\/([^\/]+)(.+)$/.test(e) &&
                (e = e.replace(RegExp.$2, t + ":" + n)),
              v.cookie("webVideoCtrlProxy", RegExp.$2, { raw: !0 }),
              e
            );
          },
          N = function () {
            return (
              ...
              "</ResponseStatus>",
              v.loadXML(
                "<ResponseStatus><requestURL></requestURL><statusCode>4</statusCode><statusString>Invalid Operation</statusString><subStatusCode>notSupport</subStatusCode></ResponseStatus>"
              )
            );
          };
        (this.I_SupportNoPlugin = function () {
          ...
          (this.I_InsertOBJECTPlugin = function (e) {
            if (
              (M(e) || (p.szContainerID = e),
              null == document.getElementById(p.szContainerID))
            )
              return -1;
            if (
              null != document.getElementById(u) ||
              0 != document.getElementsByName(u).length
            )
              return -1;
            if (Z()) {
              var t = {
              ...
              if ("" != n) {
                for (
                  var r = {}, s = n.split(";"), o = "", i = 0, a = s.length;
                  i < a;
                  i++
                )
                  -1 < (o = s[i]).indexOf("sub-background")
                    ? (r.background = "#" + o.split(":")[1])
                    : -1 < o.indexOf("sub-border-select")
                    ? (r.borderSelect = "#" + o.split(":")[1])
                    : -1 < o.indexOf("sub-border") &&
                      (r.border = "#" + o.split(":")[1]);
                t.oStyle = r;
              }
              y = new JSPlugin(t);
            } else
              (document.getElementById(p.szContainerID).innerHTML = q()),
                (y = v.browser().msie
                  ? document.getElementById(u)
                  : document.getElementsByName(c)[0]);
            return null == y && null == y.object
              ? -1
              : ("object" == typeof window.attachEvent &&
                  v.browser().msie &&
                  (y.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
                  y.attachEvent("ZoomInfoCallback", ZoomInfoCallback),
                  y.attachEvent("GetHttpInfo", GetHttpInfo),
                  y.attachEvent("PluginEventHandler", PluginEventHandler),
                  y.attachEvent("RemoteConfigInfo", RemoteConfigInfo),
                  y.attachEvent("KeyBoardEventInfo", KeyBoardEventInfo)),
                R(),
                0);
          }),
            ...
            return Z()
              ...
              : (document.writeln(q()),
                null ==
                  (y = v.browser().msie
                    ? document.getElementById(u)
                    : document.getElementsByName(c)[0]) && null == y.object
                  ? -1
                  : ("object" == typeof window.attachEvent &&
                      v.browser().msie &&
                      (y.attachEvent("GetSelectWndInfo", GetSelectWndInfo),
          ...
          (this.I_OpenFileDlg = function (e) {
            var t = "";
            if (Z()) return t;
            if (null == (t = y.HWP_OpenFileBrowser(e, ""))) return "";
            if (1 == e) {
              if (100 < t.length) return -1;
            } else if (130 < t.length) return -1;
            return t;
          }),
          (this.I2_OpenFileDlg = function (t) {
            ...
            return (
              Z()
                ? y.JS_OpenFileBrowser(t, "").then(function (e) {
                    null != e
                      ? 1 == t
                        ? 100 < e.length && n.resolve(-1)
                        : 130 < e.length && n.resolve(-1)
                      : n.resolve(),
                      n.resolve(e);
                  })
                : (null != (e = y.HWP_OpenFileBrowser(t, ""))
                    ? 1 == t
                      ? 100 < e.length && n.resolve(-1)
                      : 130 < e.length && n.resolve(-1)
                    : n.resolve(),
          ...
          (this.I_GetLocalCfg = function () {
            ...
            return (
              ...
              n.push(
                "<ProtocolType>" +
                  re.$XML(g).find("ProtocolType").eq(0).text() +
                  "</ProtocolType>"
              ),
              n.push(
                "<PackgeSize>" +
                  re.$XML(g).find("PackgeSize").eq(0).text() +
                  "</PackgeSize>"
              ),
              n.push(
                "<PlayWndType>" +
                  re.$XML(g).find("PlayWndType").eq(0).text() +
                  "</PlayWndType>"
              ),
              n.push(
                "<BuffNumberType>" +
                  re.$XML(g).find("BuffNumberType").eq(0).text() +
                  "</BuffNumberType>"
              ),
              n.push(
                "<RecordPath>" +
                  re.$XML(g).find("RecordPath").eq(0).text() +
                  "</RecordPath>"
              ),
              n.push(
                "<CapturePath>" +
                  re.$XML(g).find("CapturePath").eq(0).text() +
                  "</CapturePath>"
              ),
              n.push(
                "<PlaybackFilePath>" +
                  re.$XML(g).find("PlaybackFilePath").eq(0).text() +
                  "</PlaybackFilePath>"
              ),
              n.push(
                "<PlaybackPicPath>" +
                  re.$XML(g).find("PlaybackPicPath").eq(0).text() +
                  "</PlaybackPicPath>"
              ),
              n.push(
                "<DeviceCapturePath>" +
                  re.$XML(g).find("DeviceCapturePath").eq(0).text() +
                  "</DeviceCapturePath>"
              ),
              n.push(
                "<DownloadPath>" +
                  re.$XML(g).find("DownloadPath").eq(0).text() +
                  "</DownloadPath>"
              ),
              n.push(
                "<IVSMode>" +
                  re.$XML(g).find("IVSMode").eq(0).text() +
                  "</IVSMode>"
              ),
              n.push(
                "<CaptureFileFormat>" +
                  re.$XML(g).find("CaptureFileFormat").eq(0).text() +
                  "</CaptureFileFormat>"
              ),
              n.push("</LocalConfigInfo>"),
              (e = v.loadXML(n.join("")))
          ...
          (this.I_SetLocalCfg = function (e) {
            ...
            return (
              re
                ...
                .find("ProtocolType")
                .eq(0)
                .text(re.$XML(t).find("ProtocolType").eq(0).text()),
              re
                .$XML(g)
                .find("PackgeSize")
                .eq(0)
                .text(re.$XML(t).find("PackgeSize").eq(0).text()),
              re
                .$XML(g)
                .find("PlayWndType")
                .eq(0)
                .text(re.$XML(t).find("PlayWndType").eq(0).text()),
              re
                .$XML(g)
                .find("BuffNumberType")
                .eq(0)
                .text(re.$XML(t).find("BuffNumberType").eq(0).text()),
              re
                .$XML(g)
                .find("RecordPath")
                .eq(0)
                .text(re.$XML(t).find("RecordPath").eq(0).text()),
              re
                .$XML(g)
                .find("CapturePath")
                .eq(0)
                .text(re.$XML(t).find("CapturePath").eq(0).text()),
              re
                .$XML(g)
                .find("PlaybackFilePath")
                .eq(0)
                .text(re.$XML(t).find("PlaybackFilePath").eq(0).text()),
              re
                .$XML(g)
                .find("DeviceCapturePath")
                .eq(0)
                .text(re.$XML(t).find("DeviceCapturePath").eq(0).text()),
              re
                .$XML(g)
                .find("PlaybackPicPath")
                .eq(0)
                .text(re.$XML(t).find("PlaybackPicPath").eq(0).text()),
              re
                .$XML(g)
                .find("DownloadPath")
                .eq(0)
                .text(re.$XML(t).find("DownloadPath").eq(0).text()),
              re
                .$XML(g)
                .find("IVSMode")
                .eq(0)
                .text(re.$XML(t).find("IVSMode").eq(0).text()),
              re
                .$XML(g)
                .find("CaptureFileFormat")
                .eq(0)
                .text(re.$XML(t).find("CaptureFileFormat").eq(0).text()),
              y.HWP_SetLocalConfig(v.toXMLStr(g)) ? 0 : -1
            );
          });
        var F = function (r, s, o, i, a, u, c) {
          var e = { protocol: s, success: null, error: null };
          v.extend(e, c),
            v.extend(e, {
              success: function (e) {
                var t,
                ...
                (n.szIP = r),
                  2 == s
                    ? ((n.szHttpProtocol = "https://"), (n.iHttpsPort = o))
                    : ((n.szHttpProtocol = "http://"), (n.iHttpPort = o)),
                  (n.iCGIPort = o),
        ...
        function O() {
          if (void 0 !== O.unique) return O.unique;
          (this.szIP = ""),
            (this.szHostName = ""),
            (this.szAuth = ""),
        ...
        (this.getAuthType = function (t, n, e, r, s, o) {
          ...
          (this.setDeviceInfo = function (e, t, n, r, s) {
            return (
              ((t = new O()).szIP = n),
              2 == r
                ? ((t.szHttpProtocol = "https://"), (t.iHttpsPort = s))
                : ((t.szHttpProtocol = "http://"), (t.iHttpPort = s)),
              (t.iCGIPort = s),
              (t.szDeviceIdentify = n + "_" + s),
              (t.iDeviceProtocol = x),
              (t.oProtocolInc = e),
              t
            );
          ...
          (this.successV1cb = function (e, t, n, r, s, o, i, a) {
            (t = this.setDeviceInfo(e, t, n, r, s)).szAuth = re
              .$XML(o)
              .find("sessionID")
              .eq(0)
              .text();
          ...
          (this.successV2cb = function (e, t, n, r, s, o, i, a) {
            ((t = this.setDeviceInfo(e, t, n, r, s)).szAuth = L(
              0,
              t.szDeviceIdentify
            )),
              w(t),
          ...
          (this.I_LoginV1 = function (n, r, s, o, i, a, u, c) {
            var l = this,
              e = { success: null, error: null };
            return (
              v.extend(e, {
                success: function (e) {
                  var t = { success: null, error: null };
                  v.extend(t, {
                    success: function (e) {
                      c.success &&
                        (c.success(e), l.successV1cb(n, r, s, o, i, e, u, a));
                    },
                    error: function (e, t) {
                      c.error && c.error(e, t);
                    },
          ...
          (this.I_Login = function (r, s, o, i, a, u) {
            ...
            var c = S,
              l = x;
            if (
              (M(u.cgi) || (l = x == u.cgi ? ((c = S), x) : ((c = C), 2)), Z())
            )
              if (x == l) {
                var d = new O();
                this.getAuthType(d, r, s, o, i, function () {
                  ...
                  if (2 < e) u.error && u.error(e);
                    ...
                    var n = MD5(new Date().getTime().toString()).substring(
                      0,
                      8
                    );
            ...
            if ((v.extend(c, t), -1 != n)) {
              ...
              if (Z()) {
                ...
                (s = /^(https)(.*)$/.test(d) ? "wss://" : "ws://"),
                  ...
                  (a = c.iStreamType),
                  (i =
                    c.iChannelID <= l.iAnalogChannelNum
                      ? c.iChannelID
                      : l.oStreamCapa.iIpChanBase +
                        parseInt(c.iChannelID, 10) -
                        l.iAnalogChannelNum -
                        1),
                  (u = !0);
              } else {
                o =
                  0 ==
                    parseInt(
                      re.$XML(g).find("ProtocolType").eq(0).text(),
                      10
                    ) && l.oStreamCapa.bSupportShttpPlay
                    ? (b("SHTTP RealPlay"),
              ...
              if (-1 == o)
                return b("获取端口号失败"), void (t.error && t.error());
              v.extend(c, {
                urlProtocol: s,
                cgi: r,
                iPort: o,
              ...
              var p = this;
              -1 == n &&
                l.oProtocolInc.startRealPlay(l, c).then(
                  function () {
          ...
          (this.I_Stop = function (e) {
            ...
            if (-1 != n) {
              var r = m[n];
              if (
                (r.bRecord && (Z() || y.HWP_StopSave(r.iIndex)),
                r.bSound && (Z() || y.HWP_CloseSound()),
                r.bEZoom && (Z() || y.HWP_DisableZoom(r.iIndex)),
                Z())
              )
                y.JS_Stop(t.iWndIndex).then(
                  function () {
          ...
          (this.I_OpenSound = function (e) {
            ...
            if (-1 != t) {
              var r = m[t];
              r.bSound ||
                (0 == (n = Z() ? y.JS_OpenSound(e) : y.HWP_OpenSound(e)) &&
                  (r.bSound = !0));
            }
            return n;
          }),
          (this.I_CloseSound = function (e) {
            ...
            if (-1 != t) {
              var r = m[t];
              r.bSound &&
                0 == (n = Z() ? y.JS_CloseSound() : y.HWP_CloseSound()) &&
                (r.bSound = !1);
            }
            return n;
          }),
          (this.I_SetVolume = function (e, t) {
            ...
            return (
              ...
              isNaN(e) ||
                ...
                100 < e ||
                ((t = M(t) ? P : t),
                -1 != this.findWndIndexByIndex(t) &&
                  (n = Z()
                    ? (y.JS_SetVolume(t, e), 0)
                    : y.HWP_SetVolume(t, e))),
              n
            );
          }),
          (this.I2_CapturePic = function (e, t) {
            var n = { iWndIndex: P, bDateDir: !0 };
              ...
              if (Z()) {
                ...
                ".jpg" === e.slice(-4).toLowerCase()
                  ...
                  : ".bmp" === e.slice(-4).toLowerCase() &&
                    ((e = e.slice(0, -4)), (o = "BMP")),
                  y.JS_CapturePicture(n.iWndIndex, e, o).then(
                    function () {
                      s.resolve();
                    },
                    function () {
                ...
                ".jpg" === e.slice(-4).toLowerCase()
                  ...
                  : ".jpeg" === e.slice(-5).toLowerCase() &&
                    (e = e.slice(0, -5)),
                  0 === y.HWP_CapturePicture(n.iWndIndex, e, n.bDateDir)
                    ? s.resolve()
                    : s.reject();
            else s.reject();
            return s;
          ...
          (this.I2_CapturePicData = function (e) {
            var t = { iWndIndex: P, bDateDir: !0 };
            a(e) ? v.extend(t, e) : M(e) || (t.iWndIndex = e);
            if (-1 != this.findWndIndexByIndex(t.iWndIndex)) {
              var n = $.Deferred();
              Z()
                ? y.JS_CapturePictureData(t.iWndIndex).then(
                    function (e) {
                      n.resolve(e);
                    },
                    function (e) {
          ...
          (this.I_StartRecord = function (e, t) {
            ...
            if (-1 != r) {
              ...
              if (s.bRecord) n.error && n.error();
                ...
                v.browser().chrome
                  ? y.JS_StartSave(n.iWndIndex, e).then(
                      function () {
                ...
                0 == y.HWP_StartSave(n.iWndIndex, e, n.bDateDir)
                  ? ((s.bRecord = !0), n.success && n.success())
                  : n.error && n.error();
          ...
          (this.I_StopRecord = function (e) {
            ...
            if (-1 != n) {
              ...
              if (r.bRecord)
                if (Z())
                  v.browser().chrome
                    ? y.JS_StopSave(t.iWndIndex).then(
                        function () {
          ...
          (this.I_StartVoiceTalk = function (e, t) {
            ...
            if (-1 != n) {
              var s = I[n];
              s.bVoiceTalk ||
                (0 == (r = Z() ? -1 : s.oProtocolInc.startVoiceTalk(s, t)) &&
                  (I[n].bVoiceTalk = !0));
            }
            return r;
          }),
          ...
          (this.I_PTZControl = function (e, t, n) {
            var r = { iWndIndex: P, iPTZIndex: e, iPTZSpeed: 4 };
            v.extend(r, n), v.extend(r, { async: !1 });
          ...
          (this.I_EnableEZoom = function (e) {
            ...
            if (-1 != t) {
              var r = m[t];
              r.bEZoom ||
                (0 == (n = Z() ? y.JS_EnableZoom(e) : y.HWP_EnableZoom(e, 0)) &&
                  (r.bEZoom = !0));
            }
            return n;
          }),
          (this.I_DisableEZoom = function (e) {
            ...
            if (-1 != t) {
              ...
              r.bEZoom &&
                0 ==
                  (n = Z() ? y.JS_DisableZoom(e) : (y.HWP_DisableZoom(e), 0)) &&
                (r.bEZoom = !1);
            }
            return n;
          }),
          (this.I_Enable3DZoom = function (e) {
            ...
            if (-1 != t) {
              ...
              r.b3DZoom ||
                (Z()
                  ? ((n = 0),
                    y.JS_Enable3DZoom(e, function (e) {
                      window.ZoomInfoCallback(e);
                    }))
                  : (n = y.HWP_EnableZoom(e, 1)),
                0 == n && (r.b3DZoom = !0));
            }
            return n;
          }),
          (this.I_Disable3DZoom = function (e) {
            ...
            if (-1 != t) {
              ...
              r.b3DZoom &&
                0 ==
                  (n =
                    (Z() ? y.JS_Disable3DZoom(e) : y.HWP_DisableZoom(e), 0)) &&
                (r.b3DZoom = !1);
            }
            return n;
          }),
          ...
          (this.I_StartPlayback = function (e, t) {
            var n = this.findDeviceIndexByIP(e),
              ...
              i = 1,
              a = 0,
              u = v.dateFormat(new Date(), "yyyy-MM-dd"),
              c = {
                iWndIndex: P,
                iStreamType: 1,
                iChannelID: 1,
            ...
            if ((v.extend(c, t), -1 != n)) {
              ...
              if (Z()) {
                if (!l.bSupportWebsocket)
                  return void (t.error && t.error(403, N()));
                if (!M(c.oTransCodeParam)) return void (t.error && t.error());
              ...
              if (-1 == o)
                return b("获取端口号失败"), void (t.error && t.error());
              v.extend(c, { urlProtocol: s, cgi: r, iPort: o, iChannelID: i }),
                -1 == (n = this.findWndIndexByIndex(c.iWndIndex)) &&
                  (Z()
                    ? ((c.szStartTime = c.szStartTime.replace(" ", "T") + "Z"),
                      (c.szEndTime = c.szEndTime.replace(" ", "T") + "Z"),
                      l.oProtocolInc.startPlayback(l, c).then(
                        function () {
                          t.success && t.success();
                        },
                        function () {
                    ...
                    : ((c.szStartTime =
                        c.szStartTime.replace(/[-:]/g, "").replace(" ", "T") +
                        "Z"),
                      (c.szEndTime =
                        c.szEndTime.replace(/[-:]/g, "").replace(" ", "T") +
                        "Z"),
                      l.oProtocolInc.startPlayback(l, c).then(
                        function () {
                          t.success && t.success();
          ...
          (this.I_ReversePlayback = function (e, t) {
            var n = this.findDeviceIndexByIP(e),
              ...
              a = -1,
              u = 0,
              c = v.dateFormat(new Date(), "yyyy-MM-dd"),
              l = {
                iWndIndex: P,
                iStreamType: 1,
                iChannelID: 1,
                ...
                (i =
                  0 ==
                    parseInt(
                      re.$XML(g).find("ProtocolType").eq(0).text(),
                      10
                    ) && d.oStreamCapa.bSupportShttpPlay
                    ? ((s = d.oProtocolInc.CGI.startShttpReversePlayback),
                      (o = "http://"),
                      (u = l.iStreamType - 1),
                      (a =
                        100 *
                      ...
                      M(l.iPort)
                        ? "https://" == d.szHttpProtocol
                          ? (-1 == d.iHttpPort &&
                              (d.iHttpPort = W(d).iHttpPort),
                            d.iHttpPort)
                          : d.iCGIPort
                        : ((d.iHttpPort = l.iPort), l.iPort))
                    : ((s = d.oProtocolInc.CGI.startPlayback),
                      (o = "rtsp://"),
                      (u = l.iStreamType),
                      (a = 100 * l.iChannelID + u),
                      M(l.iRtspPort) || (d.iRtspPort = l.iRtspPort),
                      -1 == d.iRtspPort && (d.iRtspPort = W(d).iRtspPort),
                      d.iRtspPort))
              )
                return b("获取端口号失败"), r;
              v.extend(l, { urlProtocol: o, cgi: s, iPort: i, iChannelID: a }),
                -1 == (n = this.findWndIndexByIndex(l.iWndIndex)) &&
                  ((l.szStartTime =
                    l.szStartTime.replace(/[-:]/g, "").replace(" ", "T") + "Z"),
                  (l.szEndTime =
                    l.szEndTime.replace(/[-:]/g, "").replace(" ", "T") + "Z"),
                  (r = d.oProtocolInc.reversePlayback(d, l)));
            }
          ...
          (this.I_Frame = function (e) {
            ...
            if (-1 != n) {
              ...
              if (2 == s || 4 == s)
                if (Z())
                  y.JS_FrameForward(t.iWndIndex).then(
                    function () {
                  ...
                  0 == y.HWP_FrameForward(t.iWndIndex)
                    ? ((r.iPlayStatus = 4), t.success && t.success())
                    : t.error && t.error();
              else t.error && t.error();
            } else t.error && t.error();
          ...
          (this.I_Pause = function (e) {
            ...
            if (-1 != n) {
              ...
              if (2 == s) o = 3;
                ...
                if (5 != s) return void (t.error && t.error());
                o = 6;
              }
              if (Z())
                y.JS_Pause(t.iWndIndex).then(
                  function () {
          ...
          (this.I_Resume = function (e) {
            ...
            if (-1 != n) {
              ...
              if (3 == s || 4 == s) o = 2;
                ...
                if (6 != s) return void (t.error && t.error());
                o = 5;
              }
              if (Z())
                y.JS_Resume(t.iWndIndex).then(
                  function () {
                    (r.iPlayStatus = o), t.success && t.success();
                  },
                  function () {
          ...
          (this.I_PlaySlow = function (e) {
            ...
            -1 != n
              ? 2 == m[n].iPlayStatus
                ? Z()
                  ? y.JS_GetWndStatus(t.iWndIndex).iRate <= -4
                    ? t.error && t.error()
                    : y.JS_Slow(t.iWndIndex).then(
                        function () {
                          t.success && t.success();
                        },
                        function () {
          ...
          (this.I_PlayFast = function (e) {
            ...
            -1 != n
              ? 2 == m[n].iPlayStatus
                ? Z()
                  ? 8 <= y.JS_GetWndStatus(t.iWndIndex).iRate
                    ? t.error && t.error()
                    : y.JS_Fast(t.iWndIndex).then(
                        function () {
                          t.success && t.success();
                        },
                        function () {
          ...
          (this.I_GetOSDTime = function (e) {
            var n = { iWndIndex: P };
            if (
              (a(e) ? v.extend(n, e) : M(e) || (n.iWndIndex = e),
              -1 != this.findWndIndexByIndex(n.iWndIndex))
            ) {
              if (Z())
                y.JS_GetOSDTime(n.iWndIndex).then(
                  function (e) {
                    if (n.success) {
                      var t = v.dateFormat(
                        new Date(1e3 * e),
                ...
                var t = y.HWP_GetOSDTime(n.iWndIndex),
                  r = v.dateFormat(new Date(1e3 * t), "yyyy-MM-dd hh:mm:ss");
                n.success(r);
              }
            } else n.error && n.error();
          }),
          ...
          (this.I_GetDownloadStatus = function (e) {
            var t = -1;
            return (
              Z() || (1 == (t = y.HWP_GetDownloadStatus(e)) && (t = -1)), t
            );
          }),
          ...
          (this.I_RemoteConfig = function (e, t) {
            var n = this.findDeviceIndexByIP(e),
              r = -1;
            if (Z()) return -1;
            var s = { iLan: 0, iDevicePort: -1, iType: 0 };
            if ((v.extend(s, t), -1 == n)) return -1;
            var o = I[n];
            if (-1 == s.iDevicePort)
              if (-1 == o.iDevicePort) {
                if (
                  ((o.iDevicePort = W(o).iDevicePort),
                  -1 == (r = o.iDevicePort))
                )
                  return -1;
            ...
            if (":" == v.Base64.decode(o.szAuth)[0])
              var i = v.Base64.decode(o.szAuth).split(":")[1],
                a = v.Base64.decode(o.szAuth).split(":")[2];
            else
              (i = v.Base64.decode(o.szAuth).split(":")[0]),
                (a = v.Base64.decode(o.szAuth).split(":")[1]);
            var u =
          ...
          (this.I_ChangeWndNum = function (e) {
            return isNaN(parseInt(e, 10))
              ? -1
              : (Z() ? y.JS_ArrangeWindow(e) : y.HWP_ArrangeWindow(e), 0);
          }),
          ...
          (this.I_SetSnapDrawMode = function (e, t) {
            return Z()
              ? -1 < t
                ? y.JS_SetDrawStatus(!0)
                : y.JS_SetDrawStatus(!1)
              : y.HWP_SetSnapDrawMode(e, t);
          }),
          (this.I2_SetSnapPolygonInfo = function (e, t) {
            if (Z()) {
              ...
              var n = v.loadXML(t),
                r = [];
              for (
                nodeList = re.$XML(n).find("SnapPolygon", !0),
                  i = 0,
                ...
                node = nodeList[i];
                var s = U(
                  re.$XML(node).find("r").eq(0).text(),
                  re.$XML(node).find("g").eq(0).text(),
                  re.$XML(node).find("b").eq(0).text()
                );
                s = "#" + (s = V(s, 6));
                for (
                  var o = [],
                    a = re.$XML(node).find("point", !0),
                    u = 0,
                    c = a.length;
                  u < c;
                  u++
                  ...
                  (oNodePoint = a[u]),
                    o.push([
                      500 * re.$XML(oNodePoint).find("x").eq(0).text(),
                      300 * re.$XML(oNodePoint).find("y").eq(0).text(),
                    ]);
                r.push({
                  iPolygonType: 1,
          ...
          (this.I_SetSnapPolygonInfo = function (e, t) {
            if (Z()) {
              var n = y.JS_GetPolygonInfo(),
                r = v.loadXML(t),
                s = [];
              for (
                a = 0, u = (p = re.$XML(r).find("SnapPolygon", !0)).length;
                a < u;
                a++
              ) {
                h = p[a];
                var o = U(
                  re.$XML(h).find("r").eq(0).text(),
                  re.$XML(h).find("g").eq(0).text(),
                  re.$XML(h).find("b").eq(0).text()
                );
                (o = "#" + (o = V(o, 6))),
                  s.push({
                    ...
                    style: { szDrawColor: o, iTranslucent: 0.1 },
                  });
              }
              0 === p.length &&
                s.push({
              ...
              if (
                ...
                (S = "," + (S = i.join(",")) + ","),
                32 < n.length + s.length)
              )
                return -3;
              for (var a = 0, u = s.length; a < u; a++) {
                var c = (h = s[a]).id;
                if (!v.isInt(c)) return -2;
                if ((f = parseInt(c, 10)) < 1 || 32 < f) return -2;
                if (-1 < S.indexOf("," + c + ",")) return -4;
                if (32 < h.tips.length) return -2;
                if (!h.flag) {
                  var l = h.iMinPointSupport;
                  if (!v.isInt(l)) return -2;
                  if ((P = parseInt(l, 10)) < 4 || 17 < P) return -2;
                  var d = h.iMaxPointSupport;
                  if (!v.isInt(d)) return -2;
                  if ((I = parseInt(d, 10)) < P || 17 < I) return -2;
                }
              }
            ...
            var p,
              ...
              P,
              I,
              m = y.HWP_GetSnapPolygonInfo(e);
            r = v.loadXML(m);
            var S,
              C = (p = re.$XML(r).find("SnapPolygon", !0)).length;
            i = [];
            ...
            if (
              ((S = "," + (S = i.join(",")) + ","),
              (r = v.loadXML(t)),
              32 < C + (p = re.$XML(r).find("SnapPolygon", !0)).length)
            )
              return -3;
            for (a = 0, u = p.length; a < u; a++) {
              if (
                ((h = p[a]),
                (c = re.$XML(h).find("id").eq(0).text()),
                !v.isInt(c))
              )
                return -2;
              if ((f = parseInt(c, 10)) < 1 || 32 < f) return -2;
              if (-1 < S.indexOf("," + c + ",")) return -4;
              if (32 < re.$XML(h).find("tips").eq(0).text().length) return -2;
              if (!("true" === re.$XML(h).find("isClosed").eq(0).text())) {
                if (
                  ((l = re.$XML(h).find("MinClosed").eq(0).text()), !v.isInt(l))
                )
                  return -2;
                if ((P = parseInt(l, 10)) < 4 || 17 < P) return -2;
                if (
                  ((d = re.$XML(h).find("PointNumMax").eq(0).text()),
                  !v.isInt(d))
                )
                  return -2;
                if ((I = parseInt(d, 10)) < P || 17 < I) return -2;
          ...
          (this.I_DeviceCapturePic = function (e, t, n, r) {
            ...
            if (-1 != s) {
              ...
              if (
                (v.extend(a, r),
                !M(a.iResolutionWidth) && !v.isInt(a.iResolutionWidth))
              )
                return o;
          ...
          (this.findDeviceIndexByIP = function (e) {
            if (-1 < e.indexOf("_")) {
              for (var t = 0, n = I.length; t < n; t++)
                if (I[t].szDeviceIdentify == e) return t;
            } else
              for (t = 0, n = I.length; t < n; t++)
                if (I[t].szIP == e) return t;
            return -1;
          }),
          (this.findWndIndexByIndex = function (e) {
            for (var t = 0, n = m.length; t < n; t++)
              if (m[t].iIndex == e) return t;
            return -1;
          });
        var J = function () {
            (this.iIndex = 0),
        ...
        (K.prototype.m_httpRequestSet = []),
          (K.prototype.setRequestParam = function (e) {
          ...
          (K.prototype.submitRequest = function () {
            ...
            if (Z()) {
              ...
              if (this.options.async) {
                ...
                var c = y.HWP_SendHttpSynRequest(
                  a,
                  this.options.url,
                  this.options.auth,
                  this.options.data,
            ...
            "" == t || M(t)
              ...
              : ((r = parseInt(t.substring(0, 3))),
                ...
                isNaN(r)
                  ...
                  : 200 == r
                  ? this.options &&
                    -1 < this.options.url.indexOf("?format=json")
                    ? e.funSuccessCallback(JSON.parse(n))
                    : e.funSuccessCallback(v.loadXML(n))
                  : e.funErrorCallback && e.funErrorCallback(r, v.loadXML(n)));
          });
        var e = function () {};
        (e.prototype.CGI = {
              ...
              v.extend(s, {
                success: function (e) {
                  ...
                  t.push("<DeviceInfo>"),
                    t.push(
                      "<deviceName>" +
                        v.escape(re.$XML(e).find("deviceName").eq(0).text()) +
                        "</deviceName>"
                    ),
                    t.push(
                      "<deviceID>" +
                        re.$XML(e).find("deviceID").eq(0).text() +
                        "</deviceID>"
                    ),
                    t.push(
                      "<deviceType>" +
                        re.$XML(e).find("deviceType").eq(0).text() +
                        "</deviceType>"
                    ),
                    t.push(
                      "<model>" +
                        re.$XML(e).find("model").eq(0).text() +
                        "</model>"
                    ),
                    t.push(
                      "<serialNumber>" +
                        re.$XML(e).find("serialNumber").eq(0).text() +
                        "</serialNumber>"
                    ),
                    t.push(
                      "<macAddress>" +
                        re.$XML(e).find("macAddress").eq(0).text() +
                        "</macAddress>"
                    ),
                    t.push(
                      "<firmwareVersion>" +
                        re.$XML(e).find("firmwareVersion").eq(0).text() +
                        "</firmwareVersion>"
                    ),
                    t.push(
                      "<firmwareReleasedDate>" +
                        re.$XML(e).find("firmwareReleasedDate").eq(0).text() +
                        "</firmwareReleasedDate>"
                    ),
                    t.push(
                      "<encoderVersion>" +
                        re.$XML(e).find("encoderVersion").eq(0).text() +
                        "</encoderVersion>"
                    ),
                    t.push(
                      "<encoderReleasedDate>" +
                        re.$XML(e).find("encoderReleasedDate").eq(0).text() +
                        "</encoderReleasedDate>"
                    ),
                    t.push("</DeviceInfo>"),
                    (e = v.loadXML(t.join(""))),
          ...
          (e.prototype.getAnalogChannelInfo = function (i, a) {
            var e = T(
            ...
            v.extend(n, a),
              v.extend(n, {
                success: function (e) {
                  ...
                  var n = re.$XML(e).find("VideoInputChannel", !0);
                  i.iAnalogChannelNum = n.length;
                  for (var r = 0, s = n.length; r < s; r++) {
                    var o = n[r];
                    t.push("<VideoInputChannel>"),
                      t.push(
                        "<id>" + re.$XML(o).find("id").eq(0).text() + "</id>"
                      ),
                      t.push(
                        "<inputPort>" +
                          re.$XML(o).find("inputPort").eq(0).text() +
                          "</inputPort>"
                      ),
                      t.push(
                        "<name>" +
                          v.escape(re.$XML(o).find("name").eq(0).text()) +
                          "</name>"
                      ),
                      t.push(
                        "<videoFormat>" +
                          re.$XML(o).find("videoFormat").eq(0).text() +
                          "</videoFormat>"
                      ),
                      t.push("</VideoInputChannel>");
                  }
            ...
            v.extend(r, i),
              v.extend(r, {
                success: function (e) {
                  ...
                  for (
                    var n = re.$XML(e).find("InputProxyChannel", !0),
                      r = 0,
                      s = n.length;
                    r < s;
                    r++
            ...
            if (
              (this.getDigitalChannel(e, {
                ...
                success: function (e) {
                  u = e;
                  for (
                    var t = re.$XML(u).find("InputProxyChannel", !0),
                      n = 0,
                      r = t.length;
                    n < r;
                    n++
                    ...
                    var s = t[n],
                      o = re.$XML(s).find("id").eq(0).text(),
                      i = re.$XML(s).find("name").eq(0).text();
                    c[o] = i;
                  }
                },
                error: function (e, t) {
              ...
              v.extend(r, a),
                v.extend(r, {
                  success: function (e) {
                    ...
                    for (
                      var n = re.$XML(e).find("InputProxyChannelStatus", !0),
                        r = 0,
                        s = n.length;
                      r < s;
                      r++
                      ...
                      var o = n[r],
                        i = re.$XML(o).find("id").eq(0).text();
                      t.push("<InputProxyChannelStatus>"),
                        t.push("<id>" + i + "</id>"),
                        t.push("<sourceInputPortDescriptor>"),
                        t.push(
                          "<proxyProtocol>" +
                            re.$XML(o).find("proxyProtocol").eq(0).text() +
                            "</proxyProtocol>"
                        ),
                        t.push(
                        ...
                        t.push(
                          "<ipAddress>" +
                            re.$XML(o).find("ipAddress").eq(0).text() +
                            "</ipAddress>"
                        ),
                        t.push(
                          "<managePortNo>" +
                            re.$XML(o).find("managePortNo").eq(0).text() +
                            "</managePortNo>"
                        ),
                        t.push(
                          "<srcInputPort>" +
                            re.$XML(o).find("srcInputPort").eq(0).text() +
                            "</srcInputPort>"
                        ),
                        t.push(
                          "<userName>" +
                            v.escape(re.$XML(o).find("userName").eq(0).text()) +
                            "</userName>"
                        ),
                        t.push(
                          "<streamType>" +
                            re.$XML(o).find("streamType").eq(0).text() +
                            "</streamType>"
                        ),
                        t.push(
                          "<online>" +
                            re.$XML(o).find("online").eq(0).text() +
                            "</online>"
                        ),
          ...
          (e.prototype.startRealPlay = function (t, n) {
            var e = 100 * n.iChannelID + n.iStreamType,
              ...
              s = t.szIP;
            if (
              ("rtsp://" === n.urlProtocol && (s = A(s)),
              (r = n.bZeroChannel
                ? (Z() && (e = 0),
                  T(n.cgi.zeroChannels, n.urlProtocol, s, n.iPort, e))
                : T(n.cgi.channels, n.urlProtocol, s, n.iPort, e)),
              p.proxyAddress && Z())
            ) {
              v.cookie("webVideoCtrlProxy", s + ":" + n.iPort, { raw: !0 }),
                (r = T(
                  n.cgi.zeroChannels,
                  n.urlProtocol,
                  p.proxyAddress.ip,
                  p.proxyAddress.wsport,
                  e
                ));
              var o = s + ":" + n.iPort;
              -1 < r.indexOf("?")
            ...
            var i = function () {
              ...
              a = $.Deferred();
            if (Z()) {
              var u = { sessionID: t.szAuth, token: L(0, t.szDeviceIdentify) };
              y.JS_Play(r, u, n.iWndIndex).then(
                function () {
                  i(), a.resolve();
                },
                function () {
              ...
              0 == y.HWP_Play(r, t.szAuth, n.iWndIndex, "", "")
                ? (i(), a.resolve())
                : a.reject();
            return a;
          }),
          ...
          (e.prototype.ptzAutoControl = function (s, e, o, i) {
            var t = o.iChannelID,
              ...
              u = "";
            if (
              ((i.iPTZSpeed = i.iPTZSpeed < 7 ? 15 * i.iPTZSpeed : 100),
              e && (i.iPTZSpeed = 0),
              s.szDeviceType != D)
            )
              (a =
                t <= s.iAnalogChannelNum
                  ? T(
          ...
          (e.prototype.ptzControl = function (e, t, n, r) {
            ...
            o =
              ...
              (e.szDeviceType != d &&
                ...
                : T(u.ipc, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID);
            var c = new K(),
              l = {
                type: "PUT",
                url: o,
          ...
          (e.prototype.recordSearch = function (e, i) {
            var t,
              ...
              r = i.iChannelID,
              s = i.iStreamType,
              o = i.szStartTime.replace(" ", "T") + "Z",
              a = i.szEndTime.replace(" ", "T") + "Z";
            (t = T(
              ...
              v.extend(c, {
                success: function (e) {
                  ...
                  t.push("<CMSearchResult>"),
                    t.push(
                      "<responseStatus>" +
                        re.$XML(e).find("responseStatus").eq(0).text() +
                        "</responseStatus>"
                    ),
                    t.push(
                      "<responseStatusStrg>" +
                        re.$XML(e).find("responseStatusStrg").eq(0).text() +
                        "</responseStatusStrg>"
                    ),
                    t.push(
                      "<numOfMatches>" +
                        re.$XML(e).find("numOfMatches").eq(0).text() +
                        "</numOfMatches>"
                    ),
                    t.push("<matchList>");
                  for (
                    var n = re.$XML(e).find("searchMatchItem", !0),
                      r = 0,
                      s = n.length;
                    r < s;
                    r++
                    ...
                    t.push("<searchMatchItem>"),
                      t.push(
                        "<trackID>" +
                          re.$XML(o).find("trackID").eq(0).text() +
                          "</trackID>"
                      ),
                      t.push(
                        "<startTime>" +
                          re.$XML(o).find("startTime").eq(0).text() +
                          "</startTime>"
                      ),
                      t.push(
                        "<endTime>" +
                          re.$XML(o).find("endTime").eq(0).text() +
                          "</endTime>"
                      ),
                      t.push(
                        "<playbackURI>" +
                          v.escape(
                            re.$XML(o).find("playbackURI").eq(0).text()
                          ) +
                          "</playbackURI>"
                      ),
                      t.push(
          ...
          (e.prototype.startPlayback = function (t, n) {
            ...
            if (("rtsp://" === n.urlProtocol && (i = A(i)), Z()))
              if (p.proxyAddress) {
                v.cookie("webVideoCtrlProxy", i + ":" + n.iPort, { raw: !0 }),
                  (e = T(
                    n.cgi,
                    n.urlProtocol,
                    p.proxyAddress.ip,
                ...
                e = T(n.cgi, n.urlProtocol, i, n.iPort, n.iChannelID, s, o);
            else e = T(n.cgi, n.urlProtocol, i, n.iPort, n.iChannelID, s, o);
            ...
            var c = function () {
              ...
              l = $.Deferred();
            if (Z()) {
              var d = { sessionID: t.szAuth, token: L(0, t.szDeviceIdentify) };
              y.JS_Play(e, d, r, s, o).then(
                function () {
                  c(), l.resolve();
                },
                function () {
          ...
          (e.prototype.reversePlayback = function (e, t) {
            ...
            var i = T(t.cgi, t.urlProtocol, o, t.iPort, t.iChannelID, r, s),
              a = y.HWP_ReversePlay(i, e.szAuth, n, r, s);
            if (0 == a) {
              var u = new J();
              (u.iIndex = n),
                (u.szIP = e.szIP),
          ...
          (e.prototype.startDownloadRecord = function (e, t) {
            var n = T(
              ...
              r =
                ...
                v.escape(t.szPlaybackURI) +
                "</playbackURI></downloadRequest>";
            return Z()
              ? ((n = B(n)), y.JS_StartDownload(n, e.szAuth, t.szFileName, r))
              : y.HWP_StartDownload(n, e.szAuth, t.szFileName, r, t.bDateDir);
          }),
          (e.prototype.exportDeviceConfig = function (e, t) {
            ...
            if (Z()) {
              ...
              return (
                ...
                y.JS_ExportDeviceConfig(n)
              );
            }
            return (
              t && (n = v.exportPasswordDeviceConfig(n, t)),
              y.HWP_ExportDeviceConfig(n, e.szAuth, "", 0)
            );
          }),
          (e.prototype.importDeviceConfig = function (e, t, n) {
            ...
            if (Z()) {
              ...
              return (
                ...
                o.submitRequest(),
                (r = B(r)),
                n && (r = v.exportPasswordDeviceConfig(r, n)),
                y.JS_UploadFile(r)
              );
            }
            return (
              n && (r = v.exportPasswordDeviceConfig(r, n)),
              y.HWP_ImportDeviceConfig(r, e.szAuth, t.szFileName, 0)
            );
          }),
          (e.prototype.restart = function (e, n) {
            var t = T(this.CGI.restart, e.szHttpProtocol, e.szIP, e.iCGIPort),
              r = new K(),
              s = {
                type: "PUT",
                url: t,
          ...
          (e.prototype.set3DZoom = function (e, t, n, r) {
            ...
            if (
              ...
              var o = v.loadXML(n),
                i = parseInt((n.startPos[0] / h) * 255, 10),
                a = parseInt((n.startPos[1] / f) * 255, 10),
                u = parseInt((n.endPos[0] / h) * 255, 10),
                c = parseInt((n.endPos[1] / f) * 255, 10);
            else
              (o = v.loadXML(n)),
                (i = parseInt(
                  re
          ...
          (e.prototype.deviceCapturePic = function (e, t, n, r) {
            ...
            var s,
              ...
              u = [];
            if (
              (v.isInt(r.iResolutionWidth) &&
                u.push("videoResolutionWidth=" + r.iResolutionWidth),
              v.isInt(r.iResolutionHeight) &&
                u.push("videoResolutionHeight=" + r.iResolutionHeight),
              0 < u.length && (a += "?" + u.join("&")),
              Z())
            ) {
              (a = B(a)),
          ...
          (e.prototype.getSessionV2Cap = function (e, t, n, r, s, o) {
            var i = "";
            i = 2 == n ? "https://" : "http://";
            var a = T(this.CGI.sessionCap, i, t, r, encodeURIComponent(s));
            a = a + "&random:" + e;
            var u = new K(),
          ...
          (e.prototype.getSessionCap = function (e, t, n, r, s) {
            var o = "";
            o = 2 == t ? "https://" : "http://";
            var i = T(this.CGI.sessionCap, o, e, n, encodeURIComponent(r)),
              a = new K(),
          ...
          (e.prototype.sessionV2Login = function (e, t, n, r, s, o, i, a) {
            ...
            u = 2 == n ? "https://" : "http://";
            var c = parseInt(
                re.$XML(i).find("sessionIDVersion").eq(0).text(),
                10
              ),
              l =
                "true" ===
                re.$XML(i).find("isSessionIDValidLongTerm").eq(0).text(),
              d = T(this.CGI.sessionLogin, u, t, r),
              p = re.$XML(i).find("sessionID").eq(0).text(),
              h = re.$XML(i).find("challenge").eq(0).text(),
              f = parseInt(re.$XML(i).find("iterations").eq(0).text(), 10),
              P = !1,
              I = "";
            0 < re.$XML(i).find("isIrreversible", !0).length &&
              ((P = "true" === re.$XML(i).find("isIrreversible").eq(0).text()),
              (I = re.$XML(i).find("salt").eq(0).text())),
            ...
            var m = v.encodePwd(
              ...
              S = "<SessionLogin>";
            (S += "<userName>" + v.escape(s) + "</userName>"),
          ...
          (e.prototype.sessionLogin = function (e, t, n, r, s, o, i) {
            ...
            var u = T(this.CGI.sessionLogin, a, e, n),
              ...
              p = !1,
              h = "";
            0 < re.$XML(o).find("isIrreversible", !0).length &&
              ((p = "true" === re.$XML(o).find("isIrreversible").eq(0).text()),
              (h = re.$XML(o).find("salt").eq(0).text()));
            var f = "";
            if (p) {
              (f = v.sha256(r + h + s)), (f = v.sha256(f + l));
              for (P = 2; P < d; P++) f = v.sha256(f);
            } else {
              f = v.sha256(s) + l;
              for (var P = 1; P < d; P++) f = v.sha256(f);
            }
            var I = "<SessionLogin>";
        ...
        (n.prototype.CGI = {
          ...
          (n.prototype.login = function (e, t, n, r) {
            ...
            v.extend(a, r),
              v.extend(a, {
                success: function (e) {
                  "200" == re.$XML(e).find("statusValue").eq(0).text()
                    ? r.success && r.success(e)
              ...
              v.extend(s, {
                success: function (e) {
                  ...
                  t.push("<DeviceInfo>"),
                    ...
                    t.push(
                      "<deviceType>" +
                        re.$XML(e).find("deviceDescription").eq(0).text() +
                        "</deviceType>"
                    ),
                    t.push(
                      "<model>" +
                    ...
                    t.push(
                      "<encoderVersion>" +
                        re.$XML(e).find("logicVersion").eq(0).text() +
                        "</encoderVersion>"
                    ),
                    t.push(
                      "<encoderReleasedDate>" +
                        re.$XML(e).find("logicReleasedDate").eq(0).text() +
                        "</encoderReleasedDate>"
                    ),
                    t.push("</DeviceInfo>"),
                    (e = v.loadXML(t.join(""))),
            ...
            v.extend(r, i),
              v.extend(r, {
                success: function (e) {
                  ...
                  t.push("<InputProxyChannelList>");
                  for (
                    var n = re.$XML(e).find("DynVideoInputChannel", !0),
                      r = 0,
                      s = n.length;
                    r < s;
                    r++
              ...
              v.extend(r, a),
                v.extend(r, {
                  success: function (e) {
                    ...
                    t.push("<InputProxyChannelStatusList>");
                    for (
                      var n = re.$XML(e).find("DynVideoInputChannelStatus", !0),
                        r = 0,
                        s = n.length;
                      r < s;
                      r++
                      ...
                      t.push("<InputProxyChannelStatus>"),
                        ...
                        t.push(
                          "<proxyProtocol>" +
                            re.$XML(o).find("adminProtocol").eq(0).text() +
                            "</proxyProtocol>"
                        ),
                        t.push(
                          "<addressingFormatType>" +
                        ...
                        t.push(
                          "<managePortNo>" +
                            re.$XML(o).find("adminPortNo").eq(0).text() +
                            "</managePortNo>"
                        ),
                        t.push(
                          "<srcInputPort>" +
                ...
                success: function (e) {
                  ...
                  for (
                    ...
                    r.push("<AdminAccessProtocol>"),
                      r.push(
                        "<id>" + re.$XML(e).find("id").eq(0).text() + "</id>"
                      ),
                      r.push(
                        "<enabled>" +
                          re.$XML(e).find("enabled").eq(0).text() +
                          "</enabled>"
                      ),
                      r.push(
                        "<protocol>" +
                      ...
                      r.push(
                        "<portNo>" +
                          re.$XML(e).find("portNo").eq(0).text() +
                          "</portNo>"
                      ),
                      r.push("</AdminAccessProtocol>");
                  }
                  C.getStreamChannels(o, {
                    ...
                    success: function (e) {
                      if (0 < re.$XML(e).find("rtspPortNo", !0).length) {
                        var t = parseInt(
                          re.$XML(e).find("rtspPortNo").eq(0).text(),
                          10
                        );
                        r.push("<AdminAccessProtocol>"),
                          r.push("<id>4</id>"),
                          ...
                          r.push("<portNo>" + t + "</portNo>"),
                          r.push("</AdminAccessProtocol>"),
                          r.push("</AdminAccessProtocolList>");
                        var n = v.loadXML(r.join(""));
                        i.success && i.success(n);
                      } else
                        C.getStreamDynChannels(o, {
                          async: !1,
                          success: function (e) {
                            if (0 < re.$XML(e).find("rtspPortNo", !0).length) {
                              var t = parseInt(
                      ...
                      success: function (e) {
                        if (0 < re.$XML(e).find("rtspPortNo", !0).length) {
                          ...
                          C.getStreamDynChannels(o, {
                            ...
                            success: function (e) {
                              if (
                                0 < re.$XML(e).find("rtspPortNo", !0).length
                              ) {
                                var t = parseInt(
                                  re.$XML(e).find("rtspPortNo").eq(0).text(),
                                  10
          ...
          (n.prototype.startRealPlay = function (e, t) {
            var n = 100 * t.iChannelID + t.iStreamType,
              r = "",
              s = e.szIP;
            "rtsp://" === t.urlProtocol && (s = A(s)),
              (r = t.bZeroChannel
                ? T(t.cgi.zeroChannels, t.urlProtocol, s, t.iPort, n)
                : T(t.cgi.channels, t.urlProtocol, s, t.iPort, n));
          ...
          (n.prototype.ptzControl = function (e, t, n, r) {
            ...
            s = T(a, e.szHttpProtocol, e.szIP, e.iCGIPort, n.iChannelID);
            var u = new K(),
              c = {
                type: "PUT",
                url: s,
          ...
          (n.prototype.deviceCapturePic = function (e, t, n, r) {
            ...
            return (
              ...
              0 < o.length && (s += "?" + o.join("&")),
              y.HWP_DeviceCapturePic(s, e.szAuth, n, r.bDateDir)
            );
          });
        var r,
          Y,
        ...
        (Q.prototype._alert = function (e) {
          ...
          (Y.prototype.eq = function (e, t) {
            var n = this.elems[this.length - 1].length,
              r = null;
            return (
              0 < n && e < n && (r = this.elems[this.length - 1][e]),
        ...
        (ee.prototype.extend = function () {
          ...
          (ee.prototype.encodePwd = function (e, t, n) {
            var r = "";
            if (n) {
              (r = v.sha256(t.userName + t.salt + e)),
                (r = v.sha256(r + t.challenge));
              for (s = 2; s < t.iIterate; s++) r = v.sha256(r);
            } else {
              r = v.sha256(e) + t.challenge;
              for (var s = 1; s < t.iIterate; s++) r = v.sha256(r);
            }
            return r;
          }),
          ...
          (ee.prototype.Base64 = {
            ...
            decode: function (e) {
              ...
              for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); u < e.length; )
                (t =
                  (this._keyStr.indexOf(e.charAt(u++)) << 2) |
                  ((s = this._keyStr.indexOf(e.charAt(u++))) >> 4)),
                  (n =
                    ((15 & s) << 4) |
                    ((o = this._keyStr.indexOf(e.charAt(u++))) >> 2)),
                  (r =
                    ((3 & o) << 6) | (i = this._keyStr.indexOf(e.charAt(u++)))),
          ...
          (ee.prototype.exportPasswordDeviceConfig = function (e, t) {
            ...
            return (
              e +
              "?secretkey=" +
              v.encodeAES(v.Base64.encode(v.encodeString(t)), szAESKey, n) +
              "&security=1&iv=" +
              n
            );
          }),
          ...
          (te.prototype.createUUID = function () {
            ...
            return (
              te.getIntegerBits(t, 0, 31) +
              "-" +
              te.getIntegerBits(t, 32, 47) +
              "-" +
              (te.getIntegerBits(t, 48, 59) + "1") +
              "-" +
              te.getIntegerBits(te.rand(4095), 0, 7) +
              te.getIntegerBits(te.rand(4095), 0, 7) +
              "-" +
              (te.getIntegerBits(te.rand(8191), 0, 7) +
                te.getIntegerBits(te.rand(8191), 8, 15) +
                te.getIntegerBits(te.rand(8191), 0, 7) +
                te.getIntegerBits(te.rand(8191), 8, 15) +
                te.getIntegerBits(te.rand(8191), 0, 15))
            );
          }),
          (te.getIntegerBits = function (e, t, n) {
            var r = te.returnBase(e, 16),
              s = new Array(),
              o = "",
              i = 0;
            for (i = 0; i < r.length; i++) s.push(r.substring(i, i + 1));
