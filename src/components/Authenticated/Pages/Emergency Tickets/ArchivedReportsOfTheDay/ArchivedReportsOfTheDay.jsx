...
const {
  ...
  updateArchivedReportsOfTheDay,
  selectOngoingTicket,
} = ticketsActions;

const ArchivedReportsOfTheDay = () => {
  ...
  const { archivedReportsOfTheDay, fetchArchivedReportsOfTheDayLoading } =
  ...
  const setAsReportOfTheDay = async (hazardId) => {
    ...
    if (!request || request.name === "AxiosError") {
      ...
      if (request?.data?.data) {
        dispatch(updateArchivedReportsOfTheDay(request?.data?.data));
      }
    }
  };
  ...
  const columns = [
              ...
              {["supervisor", "contentwriter"].includes(
                ...
                <>
                  <Button
                    ...
                    type="menu"
                    text="Revert as Report of The Day"
                  />
                  <Button
    ...
    },
    {
      ...
      //   filters: getFilters(archivedReportsOfTheDay, "caseType", getTypeName),
  ...
  return (
    <div className="bg-white p-2">
      ...
      <Table
        ...
        rowKey={"hazardId"}
        columns={columns}
        loading={fetchArchivedReportsOfTheDayLoading}
        dataSource={archivedReportsOfTheDay}
...
export default ArchivedReportsOfTheDay;
