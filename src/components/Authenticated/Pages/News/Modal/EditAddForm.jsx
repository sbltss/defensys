...
import { Button, Form, Image, Input, Select, Space, Spin, Upload } from "antd";
        ...
        <Spin spinning={isLoading}>
          <Form onFinish={onFinish} onFinishFailed={onFinishFailed} layout="vertical" form={formEditAddText}>
            ...
            <Form.Item
              ...
              // 	{
              // 		required: true,
              // 		message: 'Please select item order!',
              // 	},
              // ]}
            >
            ...
            <Form.Item>
              <Button className=" w-full h-12 rounded-lg mt-5 sm:text-lg text-base" type="primary" htmlType="submit">
                {isAdd ? "Add" : "Edit"}
              </Button>
              {/* {isAdd || (
								<Button
          ...
          <Form className=" max-w-[700px] mx-auto" onFinish={onFinish} layout="vertical" form={formEditAddImg}>
            ...
            {imagePreview && (
              <Space direction="vertical" className=" flex justify-center items-center">
                ...
                <Space>
                  <Button type="primary" onClick={removeImg}>
                    Remove
                  </Button>
                </Space>
              </Space>
          ...
          {!imagePreview && videoUrl && (
            <div className=" py-5 px-10 flex justify-center items-center">
              <video
                ...
                controls={true}
                // height={350}
                src={`${import.meta.env.VITE_BASE_URL}/${videoUrl}`}
              />
            </div>
          )}
          <Form className=" max-w-[700px] mx-auto" onFinish={onFinish} layout="vertical" form={formEditAddVid}>
            ...
            {videoPreview && (
              <Space direction="vertical" className=" flex justify-center items-center">
                ...
                <Space>
                  <Button type="primary" onClick={removeVid}>
                    Remove
                  </Button>
                </Space>
              </Space>
